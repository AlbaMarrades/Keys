...
function render(sut, renderOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({ fixture, detectChanges: () => detectChanges(), navigate,
            rerender,
            change, debugElement: typeof sut === 'string' ? fixture.debugElement : fixture.debugElement.query(By.directive(sut)), container: fixture.nativeElement, debug: (element = fixture.nativeElement, maxLength, options) => Array.isArray(element)
